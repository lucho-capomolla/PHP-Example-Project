...
class Article {
   ...
   */
     ...
     * @param string $column Optional list of columns for the select, defaults to *
     *
     ...
     */
       ...
       if ($this->validate()) {
         ...
         $sql = "INSERT INTO article (title, content, published_at)
          ...
          if($this->published_at == '') {
            $stmt->bindValue(':published_at', nulll, PDO::PARAM_NULL);
          } else {
      ...
      *
      * @return boolean True if it was succesful, false otherwise
      */
     ...
     /*
      * Publish the article, setting the published at field to the current date and time
      *
      * @param object $conn Connection to the database
      *
